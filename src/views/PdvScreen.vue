...
import {getAtributes, getHistory, getRanking, getScore, getTermometer} from "../api/mockService/ApiMockImpl.ts";
...
const loadData = async () => {
  try {
    ...
    const [scoreRes, historyRes, rankingRes, atributeRes,termometerRes] = await Promise.all([
